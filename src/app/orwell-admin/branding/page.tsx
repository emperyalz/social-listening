        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-6">
            ...
            {activeBranding ? (
              <div className="grid grid-cols-2 gap-6">
                ...
                {/* Brand Info */}
                <div className="col-span-2 grid grid-cols-3 gap-4 mt-4 pt-4 border-t border-gray-200">
                  <div>
                    <span className="text-xs text-gray-500 block mb-1">Platform Name</span>
                    <span className="font-medium">{activeBranding.platformName}</span>
                  </div>
                  <div>
                    <span className="text-xs text-gray-500 block mb-1">Primary Color</span>
                    <div className="flex items-center gap-2">
                      <div
                        className="w-6 h-6 rounded-md border border-gray-200"
                        style={{ backgroundColor: activeBranding.primaryColor }}
                      />
                      <span className="font-mono text-sm">{activeBranding.primaryColor}</span>
                    </div>
                  </div>
                  <div>
          ...
          {isEditing && (
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
              <h2 className="text-lg font-semibold text-gray-900 mb-6">Edit Branding</h2>
              ...
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#28A963] focus:border-transparent"
                      placeholder="Orwell"
                    />
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <div className="flex gap-2">
                      ...
                      <input
                        ...
                        value={formData.primaryColor}
                        onChange={(e) => setFormData((prev) => ({ ...prev, primaryColor: e.target.value }))}
                        className="flex-1 px-3 py-2 border border-gray-300 rounded-lg font-mono text-sm focus:outline-none focus:ring-2 focus:ring-[#28A963] focus:border-transparent"
                      />
                    </div>
                  </div>
                  <div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <div className="border-2 border-dashed border-gray-300 rounded-lg p-4 text-center hover:border-[#28A963] transition-colors cursor-pointer">
                      <input
                        type="file"
                        accept="image/*"
          ...
          <div className="mt-6 bg-amber-50 border border-amber-200 rounded-lg p-4">
            <div className="flex items-start gap-3">
              ...
              <div>
                <h3 className="font-medium text-amber-800">Orwell Admin Access</h3>
